...
bool task9_pkg__msg__full_name_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("task9_pkg.msg._full_name_message.FullNameMessage", full_classname_dest, 48) == 0);
  }
  task9_pkg__msg__FullNameMessage * ros_message = _ros_message;
  {  // last_name
...
PyObject * task9_pkg__msg__full_name_message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("task9_pkg.msg._full_name_message");
