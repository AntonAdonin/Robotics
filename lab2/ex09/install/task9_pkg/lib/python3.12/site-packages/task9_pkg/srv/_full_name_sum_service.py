...
class FullNameSumService_Event(metaclass=Metaclass_FullNameSumService_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<task9_pkg/FullNameSumService_Request, 1>',
        'response': 'sequence<task9_pkg/FullNameSumService_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['task9_pkg', 'srv'], 'FullNameSumService_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['task9_pkg', 'srv'], 'FullNameSumService_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from task9_pkg.srv import FullNameSumService_Request
    ...
    def response(self, value):
        if self._check_fields:
            from task9_pkg.srv import FullNameSumService_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_FullNameSumService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'task9_pkg.srv.FullNameSumService')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from task9_pkg.srv import _full_name_sum_service
...
class FullNameSumService(metaclass=Metaclass_FullNameSumService):
    from task9_pkg.srv._full_name_sum_service import FullNameSumService_Request as Request
    from task9_pkg.srv._full_name_sum_service import FullNameSumService_Response as Response
    from task9_pkg.srv._full_name_sum_service import FullNameSumService_Event as Event
