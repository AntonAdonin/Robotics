...
#ifndef TASK9_PKG__SRV__DETAIL__FULL_NAME_SUM_SERVICE__FUNCTIONS_H_
#define TASK9_PKG__SRV__DETAIL__FULL_NAME_SUM_SERVICE__FUNCTIONS_H_
 ...
 * )) before or use
 * task9_pkg__srv__FullNameSumService_Request__create()
 ...
 * calls
 * task9_pkg__srv__FullNameSumService_Request__init().
...
/**
 * It calls
 * task9_pkg__srv__FullNameSumService_Request__fini()
 ...
 * task9_pkg__srv__FullNameSumService_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * task9_pkg__srv__FullNameSumService_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * task9_pkg__srv__FullNameSumService_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_task9_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * task9_pkg__srv__FullNameSumService_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task9_pkg
...
/**
 * It calls
 * task9_pkg__srv__FullNameSumService_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_task9_pkg
...
/**
 * It allocates the memory for the array and calls
 * task9_pkg__srv__FullNameSumService_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task9_pkg
...
/**
 * It calls
 * task9_pkg__srv__FullNameSumService_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * task9_pkg__srv__FullNameSumService_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_task9_pkg
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * task9_pkg__srv__FullNameSumService_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task9_pkg
...
/**
 * It calls
 * task9_pkg__srv__FullNameSumService_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_task9_pkg
...
/**
 * It allocates the memory for the array and calls
 * task9_pkg__srv__FullNameSumService_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_task9_pkg
...
/**
 * It calls
 * task9_pkg__srv__FullNameSumService_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TASK9_PKG__SRV__DETAIL__FULL_NAME_SUM_SERVICE__FUNCTIONS_H_
