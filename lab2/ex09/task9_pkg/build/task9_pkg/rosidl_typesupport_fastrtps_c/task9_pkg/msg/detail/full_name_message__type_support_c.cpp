...
#include "task9_pkg/msg/detail/full_name_message__rosidl_typesupport_fastrtps_c.h"
...
using _FullNameMessage__ros_msg_type = task9_pkg__msg__FullNameMessage;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task9_pkg__msg__FullNameMessage;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const task9_pkg__msg__FullNameMessage * ros_message = static_cast<const task9_pkg__msg__FullNameMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_task9_pkg__msg__FullNameMessage(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  task9_pkg__msg__FullNameMessage * ros_message = static_cast<task9_pkg__msg__FullNameMessage *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_task9_pkg__msg__FullNameMessage(cdr, ros_message);
}

static uint32_t _FullNameMessage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_task9_pkg__msg__FullNameMessage(
...
static size_t _FullNameMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_task9_pkg__msg__FullNameMessage(
