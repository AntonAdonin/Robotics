...
#include "task9_pkg/srv/detail/full_name_sum_service__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const task9_pkg::srv::FullNameSumService_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task9_pkg::srv::FullNameSumService_Request & ros_message)
{
  // Member: last_name
  cdr >> ros_message.last_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task9_pkg::srv::FullNameSumService_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task9_pkg::srv::FullNameSumService_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task9_pkg::srv::FullNameSumService_Request *>(
    untyped_ros_message);
...
{
  return &task9_pkg::srv::typesupport_fastrtps_cpp::_FullNameSumService_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task9_pkg, srv, FullNameSumService_Request)() {
  return &task9_pkg::srv::typesupport_fastrtps_cpp::_FullNameSumService_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task9_pkg
cdr_serialize(
  const task9_pkg::srv::FullNameSumService_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: full_name
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task9_pkg::srv::FullNameSumService_Response & ros_message)
{
  // Member: full_name
  cdr >> ros_message.full_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task9_pkg::srv::FullNameSumService_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task9_pkg::srv::FullNameSumService_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task9_pkg::srv::FullNameSumService_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task9_pkg::srv::typesupport_fastrtps_cpp::_FullNameSumService_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task9_pkg, srv, FullNameSumService_Response)() {
  return &task9_pkg::srv::typesupport_fastrtps_cpp::_FullNameSumService_Response__handle;
}
...
// functions for task9_pkg::srv::FullNameSumService_Request already declared above

// functions for task9_pkg::srv::FullNameSumService_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task9_pkg
cdr_serialize(
  const task9_pkg::srv::FullNameSumService_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      task9_pkg::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task9_pkg::srv::FullNameSumService_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      task9_pkg::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        task9_pkg::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        task9_pkg::srv::typesupport_fastrtps_cpp::max_serialized_size_FullNameSumService_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        task9_pkg::srv::typesupport_fastrtps_cpp::max_serialized_size_FullNameSumService_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task9_pkg::srv::FullNameSumService_Event;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      task9_pkg::srv::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.request[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        task9_pkg::srv::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.request[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        task9_pkg::srv::typesupport_fastrtps_cpp::max_serialized_size_key_FullNameSumService_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        task9_pkg::srv::typesupport_fastrtps_cpp::max_serialized_size_key_FullNameSumService_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const task9_pkg::srv::FullNameSumService_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task9_pkg::srv::FullNameSumService_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task9_pkg::srv::typesupport_fastrtps_cpp::_FullNameSumService_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task9_pkg, srv, FullNameSumService_Event)() {
  return &task9_pkg::srv::typesupport_fastrtps_cpp::_FullNameSumService_Event__handle;
}
...
static const rosidl_service_type_support_t _FullNameSumService__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<task9_pkg::srv::FullNameSumService_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<task9_pkg::srv::FullNameSumService_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<task9_pkg::srv::FullNameSumService_Event>(),
...
{
  return &task9_pkg::srv::typesupport_fastrtps_cpp::_FullNameSumService__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task9_pkg, srv, FullNameSumService)() {
  return &task9_pkg::srv::typesupport_fastrtps_cpp::_FullNameSumService__handle;
}
